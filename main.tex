...
% Why is this?
% -> Towards an answer: https://tex.stackexchange.com/questions/664/why-should-i-use-usepackaget1fontenc
...
\begin{figure}
  \makebox[\textwidth][c]{\includegraphics[width=0.9\paperwidth]{img/jitterbox_noise_level}}\\%
  \makebox[\textwidth][c]{\includegraphics[width=0.9\paperwidth]{img/jitterbox_nox_emissions}}%
